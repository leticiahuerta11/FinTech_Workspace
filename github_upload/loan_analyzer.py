...
print(f"The remaining months is {remaining_months}, and the future value is ${future_value}.")
...
# loan present value to the loan price and display an evaluation.
...
# present value function using data from the new loan dictionary
